...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về quyền riêng tư và bảo vệ dữ liệu.
Phân tích khía cạnh privacy trong câu hỏi:

Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR, data protection, privacy rights, consent, data processing
và nghĩa vụ thông báo khi xảy ra data breach."""
